...
//    }
    ...
    public void checkParser() {
        String title = Parser.getPosts(resp).get(0).getTitle();
    ...
    public void fetchPosts() {
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                assertEquals(response.body(), resp);
                latch.countDown();
            }
    ...
    public void insertIntoDb() throws Exception {
        CountDownLatch latch = new CountDownLatch(1);
        List<Posts> list = Arrays.asList(new Posts("Test Title","Test Description"));
        postsDao.insert(list);
        latch.countDown();
        assertEquals("Test Title", postsDao.getPost().getTitle());
        try {
            latch.await();
        } catch (InterruptedException e) {
            e.printStackTrace();
